...
public class PhilosopherStateTests
{
    ...
    public PhilosopherStateTests()
    {
        ...
        var services = new PhilosopherServiceBundle(strategy, tableManager, eventQueue, simulationTime);
        _philosopher = new PhilosopherHostedService(options, services, 0, "Test");
    }
